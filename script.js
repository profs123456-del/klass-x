...
(function buildBossFilterPanel(){
  ...
  /* Live search — filters the boss list below by name as you type,
     and auto-expands the matching hour-group/boss row so results are
  ...
  if(searchInput){
    searchInput.addEventListener("input", () => {
      ...
      list.querySelectorAll(".hour-group").forEach(group => {
        let groupHasMatch = false;

        group.querySelectorAll(".boss-filter-item").forEach(item => {
          const nameEl = item.querySelector(".bf-name");
